...
REQUEST_CHANNEL1 = int(os.environ.get("REQUEST_CHANNEL1", "-1002232203073"))
REQUEST_CHANNEL2 = int(os.environ.get("REQUEST_CHANNEL2", "-1002323979383"))
